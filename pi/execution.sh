...
#openImage build/graph/strong_scale.png & 
...
#openImage build/graph/weak_scale.png & 
...
#openImage build/graph/strong_scale_splitN.png & 
...
#openImage build/graph/weak_scale_splitN.png & 
